...
Pod::Spec.new do |s|
  ...
  s.name         = "XBZToolKit"
  s.version      = "0.0.1"
  s.summary      = "A short description of XBZToolKit."
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/XBZToolKit"
  ...
  s.source       = { :git => "https://github.com/appledev201888/XBZToolKit.git", :tag => "#{s.version}" }
